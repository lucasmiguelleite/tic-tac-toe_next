...
const Square = ({
  ...
  return (
    <button
      className={`${value === 'X' ? 'bg-green-500' : 'bg-red-600'} ${effectClass} max-w-60 max-h-60 min-h-24 min-w-24 text-7xl text-slate-200 border border-solid border-black dark:border-gray-500 rounded-lg`}
      disabled
    >
      {value}
    </button>
