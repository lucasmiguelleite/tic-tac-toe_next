...
const OnlineMatchmaking = ({
      ...
      <div className="relative">
        <div className="static grid grid-cols-1 mx-10 h-max md:mt-52">
          <div className="inline-flex justify-center">
            <p className="font-bold text-4xl mb-10 text-center">Enter room code:</p>
          </div>
  ...
  return (
    <div className="relative">
      <div className="static grid grid-cols-1 mx-10 h-max md:mt-52">
        <div className="inline-flex justify-center">
          <p className="font-bold text-4xl mb-10 text-center">Online Multiplayer</p>
        </div>
        <div className="flex flex-col items-center gap-4">
          <button
          ...
          >
            <p className="font-bold text-2xl">Quick Match</p>
          </button>
          <button
            onClick={onCreateRoom}
            className="border border-gray-300 dark:border-gray-600 rounded-full text-center w-64 h-16 hover:bg-gray-600 hover:text-white dark:hover:bg-gray-500"
          >
            <p className="font-bold text-2xl">Create Room</p>
          </button>
          <button
            onClick={() => setShowJoin(true)}
            className="border border-gray-300 dark:border-gray-600 rounded-full text-center w-64 h-16 hover:bg-gray-600 hover:text-white dark:hover:bg-gray-500"
          >
            <p className="font-bold text-2xl">Join Room</p>
          </button>
        </div>
      </div>
    </div>
