    ...
    <div className="relative">
      <div className="static grid grid-cols-1 mx-10 h-max md:mt-52">
        <div className="inline-flex justify-center">
          <p className="font-bold text-3xl mb-8 text-center">{t('online.shareCode')}</p>
        </div>
        ...
        <div className="flex justify-center">
          <p className="text-xl text-gray-500 dark:text-gray-400 animate-pulse">{t('online.waitingOpponent')}</p>
        </div>
